#!/usr/bin/env python3
"""
Test without authentication to isolate the issue
"""
...
def test_no_auth():
    """Test without authentication to see if the issue is auth-related"""
    
    # Test the store endpoint without authentication (temporarily)
    url = "http://localhost:8000/api/v1/keyword-research/store"
    
    # Create test keyword data with unique keyword
    ...
    print("Testing database storage without authentication...")
    print(f"URL: {url}")
