...
const REQUIREMENT_ICONS = {
  min_length: <Lock fontSize="small" />,
  uppercase: <Security fontSize="small" />,
  lowercase: <Security fontSize="small" />,
  digits: <Security fontSize="small" />,
  special_chars: <Security fontSize="small" />,
  min_special_chars: <Security fontSize="small" />,
  max_consecutive: <Warning fontSize="small" />,
  max_repeated: <Warning fontSize="small" />,
  no_common_passwords: <Security fontSize="small" />,
};
