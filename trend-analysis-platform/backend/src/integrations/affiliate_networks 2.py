...
def get_network_api(network_id: str) -> Optional[AffiliateNetworkAPI]:
    """Get API instance for a specific network"""
    try:
        if network_id == "shareasale":
            return shareasale_api
            ...
            return partnerize_api
        elif network_id == "awin":
            return awin_api
        elif network_id == "flexoffers":
            return flexoffers_api
        elif network_id == "clickbank":
            return clickbank_api
        elif network_id == "rakuten":
            return rakuten_api
        elif network_id == "webgains":
            return webgains_api
        elif network_id == "tradedoubler":
            return tradedoubler_api
        elif network_id == "affiliate_window":
            return affiliate_window_api
        elif network_id == "zanox":
            return zanox_api
        elif network_id == "affiliate_future":
            return affiliate_future_api
        else:
            return None
    except Exception:
        return None
