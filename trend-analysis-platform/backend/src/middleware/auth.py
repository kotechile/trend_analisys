...
require_premium = RoleChecker([UserRole.ADMIN, UserRole.PREMIUM_USER])
require_user = RoleChecker([UserRole.ADMIN, UserRole.PREMIUM_USER, UserRole.USER])
...
def is_premium_user(user: User) -> bool:
    ...
    return user.role in [UserRole.ADMIN, UserRole.PREMIUM_USER]
