-- Create missing tables for TrendTap application with RLS
-- This script creates all the tables that the application needs with proper security
...
-- Enable RLS on authentication_logs table
...
-- Enable RLS on affiliate_research table
...
-- Enable RLS on keyword_data table
...
-- Enable RLS on content_ideas table
...
-- Enable RLS on software_solutions table
...
-- Enable RLS on export_templates table
...
-- Enable RLS on topic_analysis table
...
-- Create helper functions for RLS in public schema
